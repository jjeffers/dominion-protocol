...
func _init() -> void:
    ...
    mesh_instance.mesh = load("res://src/data/uv_test.res")
    ...
    img.save_png("/home/jdjeffers/Documents/render_front.png")
    ...
    img.save_png("/home/jdjeffers/Documents/render_back.png")
    ...
    await self.process_frame
    img = sub_window.get_texture().get_image()
    img.save_png("/home/jdjeffers/Documents/render_top.png")
